...
import numpy as np
import pandas as pd
import streamlit as st #Gives you widgets, interactable objects, to use in your webpage
...
#Creates titles for the main screen and the side bar (Widgets)
st.title("Glass Type prediction Web app")
st.sidebar.title("Display Options")

#Creates a checkbox that displays the entire dataframe, or raw data, when clicked on
if st.sidebar.checkbox("Show raw data"):
    st.subheader("Glass Type Data set")
    st.dataframe(glass_df)

#Creates a dropdown bar to give you options to visualize the data
#All values must be in the tuple format to be recognized by this function
...
# S2.1: Creates sliders for all 9 of the feature variables, allowing you to test out numerous prediction conditions
